...
def setup_logging(verbose: bool = False):
    ...
    console_handler.setLevel(logging.WARNING) # Only warnings/errors to stderr by default
    ...
    if log_file:
        try:
            ...
            print(f"Warning: Could not set up log file {log_file}: {e}", file=sys.stderr)
